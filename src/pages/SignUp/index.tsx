...
import { LOGIN_IN } from "../../constants/constants";
  ...
  return (
    <SignInSignout>
      <div className="text-center text-black">
        <h1 className="text-lg font-bold">Create a Account</h1>
        <p className="text-slate-600"> Select method to create Account.</p>
      </div>
      ...
      <div className="mt-4">
        ...
        <p className="text-slate-500 mt-3 mb-3 text-center">
          ...
          <Link to={`/${LOGIN_IN}`}>
            <span className="px-2 text-[#d31f22]">Login</span>{" "}
          </Link>
        </p>
      </div>
    </SignInSignout>
