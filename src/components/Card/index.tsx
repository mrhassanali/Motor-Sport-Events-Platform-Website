  ...
  return (
    <div className="border border-slate-300  rounded-lg relative">
      ...
      <div className="text-black p-2">
        ...
        <p className="mt-2 text-slate-800">{data.description?.slice(0,85)+"..."}</p>
        <div className="mt-2 flex flex-wrap justify-between items-end">
          <button className="border border-slate-300 w-1/4 rounded-full text-center text-3xl md:text-2xl sm:text-md xs:text-md base-text-md">
            -
          </button>
